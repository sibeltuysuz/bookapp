...
public class SepetMyAdapter extends RecyclerView.Adapter<MyHolder> {

    Context c;
    ArrayList<SepetKitap> kitaps;
    CardView cardView;
    TextView baslik, aciklama, sayfa_sayisi;

    public SepetMyAdapter(Context ctx, ArrayList<SepetKitap> kitaps) {
        this.c = ctx;
        this.kitaps = kitaps;
    }
